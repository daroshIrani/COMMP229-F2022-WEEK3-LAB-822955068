...
export function helloWorldHtml(req,res,next){
    ...
    res.render('index'); // redirect that render works with comes form Express EJS engine --> since we set up view engine in server.js as being EJS --> 
