...
export function displayhomePage(req,res,next){
    ...
    res.render('index', {title :'Home', page :'home'}); // redirect that render works with comes form Express EJS engine --> since we set up view engine in server.js as being EJS --> 
...
export function displayaboutPage(req,res, next){
    res.render('index', {title :'About', page :'about'}) // render method expects a view (index.ejs file ) and objects which are the title page etc which will be exported through 
}                                                        // the roouter as variables to use                                             
