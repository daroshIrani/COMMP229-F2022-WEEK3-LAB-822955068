...
// Import routes ************///////
import indexRouter from './routes/index.route.server.js'; // called indexRouter (name can be anyting) because it is the only thing that we are exporting from routes folder.
...
app.set('views', path.join(__dirname, '/views') ); // from server.js to app folder to views folder  -- vefore debug page saved as server.js the dir used to be 'app/views'
